...
define([
    ...
    'core/chartjs',
    'core/chart_axis',
    'local_vflibs/chart_bar',
    'core/chart_output_base',
    'local_vflibs/chart_line',
    'local_vflibs/chart_pie',
    'core/chart_series'
     ...
     *
     * @class
     * @alias module:local_vflibs/chart_output_chartjs
    ...
    Output.prototype._makeConfig = function() {
        ...
        // Get all other options from the chart definition class.
        var moreoptions = this._chart.getOptions();
        if (moreoptions instanceof Array) {
            for (const key in moreoptions) {
                config.options[key] = moreoptions[key];
            }
        }
