...
define(['jquery'], function($) {
     ...
     * Chart builder.
     *
     * @exports local_vflibs/chart_builder
     */
    var module = {
         ...
         * deferring most of the logic to {@link module:local_vflibs/chart_base.create}.
         *
        ...
        make: function(data) {
            ...
            require(['local_vflibs/chart_' + data.type], function(Klass) {
